...
input("Press Enter to continue...")
# TASK 13 (Extra)
# TODO: Plot a chart to show how many persons leaves from most popular
# start station and less popular.
print("Reading data...")
...
input("Press Enter to continue...")
# TASK 14 (Extra)
# TODO: Plot a pie chart to show the 3 start stations with most users.
